...
- The prepared Supabase Cron schedule invokes the hosted function every minute. A pass starts at most ten due items and stops starting jobs after 65 seconds. The database lease prevents overlapping passes. It does not depend on either laptop or Vercel requests.
